...
% the performance is likely suboptimal. This is in good part due to the
% fact that we compute centroids as Karcher means, which seems overly
% expensive: cheaper forms of average-like quantities might work better.
