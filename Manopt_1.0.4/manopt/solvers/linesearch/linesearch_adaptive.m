...
%     Nov. 7, 2013 (NB) :   The whole function has been recoded to mimick
%                           more closely the new version of linesearch.m.
%                           The parameters are available through the
%                           options structure passed to the solver and have
%                           the same names and same meaning as for the base
%                           linesearch. The information logged is so more
%                           reliably.
