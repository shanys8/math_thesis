...
%     end
    ...
    function Y = exponential(X, U, t)
        ...
        Y = retraction(X, U, t);
        warning('manopt:stiefel:exp', ...
		       ['Exponential for Stiefel manifold not implemented yet. ' ...
			    'Used retraction instead.']);
    end
