...
% Contributors: 
% Change log: 
%  July 16, 2013 (NB) : Added 'transposed' option, mainly for ease of
%                       comparison with the elliptope geometry.
%  Nov. 29, 2013 (NB) : Added normalize_columns function to make it easier to
%                       exploit the bsxfun formulation of column normalization,
%                       which avoids using for loops and provides performance
%                       gains. The exponential still uses a for loop.
...
% Given a matrix X, returns the same matrix but with each column scaled so that
% they have unit 2-norm.
